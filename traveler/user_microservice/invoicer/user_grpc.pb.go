...
type UserServiceClient interface {
	RegisterUser(ctx context.Context, in *UserRegister, opts ...grpc.CallOption) (*UserInfo, error)
	BlockUser(ctx context.Context, in *BlockUserRequest, opts ...grpc.CallOption) (*BlockMessage, error)
...
func (c *userServiceClient) RegisterUser(ctx context.Context, in *UserRegister, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (c *userServiceClient) BlockUser(ctx context.Context, in *BlockUserRequest, opts ...grpc.CallOption) (*BlockMessage, error) {
...
type UserServiceServer interface {
	RegisterUser(context.Context, *UserRegister) (*UserInfo, error)
	BlockUser(context.Context, *BlockUserRequest) (*BlockMessage, error)
...
func (UnimplementedUserServiceServer) RegisterUser(context.Context, *UserRegister) (*UserInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterUser not implemented")
}
func (UnimplementedUserServiceServer) BlockUser(context.Context, *BlockUserRequest) (*BlockMessage, error) {
...
func _UserService_RegisterUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).RegisterUser(ctx, req.(*UserRegister))
	}
